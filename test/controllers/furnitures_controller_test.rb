...
class FurnituresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create furniture" do
    assert_difference("Furniture.count") do
      post furnitures_url, params: { furniture: { body: @furniture.body, color: @furniture.color, image: @furniture.image, price: @furniture.price, title: @furniture.title } }
    end
  ...
  test "should update furniture" do
    patch furniture_url(@furniture), params: { furniture: { body: @furniture.body, color: @furniture.color, image: @furniture.image, price: @furniture.price, title: @furniture.title } }
